...
export default function Items({ data: { type, route, value: items }, as }) {
  ...
  return (
    ...
    <Component className="flex justify-center items-start w-full site-padding-x pt-20 pb-36 min-h-[35rem] md:py-36 lgtall:pt-48 lgtall:pb-56 2k:pt-56 2k:pb-64 bg-white">
