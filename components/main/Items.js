...
export default function Items({ data: { type, route, value: items }, as }) {
  ...
  return (
    <>
      ...
      <Component className="bg-white flex justify-center items-start w-full site-padding-x pt-20 pb-36 min-h-[180px] sm:min-h-[300px] md:py-36 md:min-h-[380px] lgtall:pt-48 lgtall:pb-56 lgtall:min-h-[450px] xl:min-h-[250px] 2xl:min-h-[350px] 3xl:min-h-[400px] 2k:pt-56 2k:pb-64 2k3:min-h-[480px]">
