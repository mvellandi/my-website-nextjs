...
const projectFields = `_id, name, description, coverImage`;

export async function getProjectAndPrevNextProjectSlugs({ slug, preview }) {
  ...
  const currentItem = await curClient.fetch(
